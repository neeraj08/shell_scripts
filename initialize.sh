#Newly installed Ubuntu? Dont want to go through the headache of installing all your software packages again ?
...
apt-get install apt-fast  # it's faster than apt-get
